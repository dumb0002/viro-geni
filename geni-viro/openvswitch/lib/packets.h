...
void viro_push_fd(struct ofpbuf *, ovs_be32 fd_sw, ovs_be16 fd_host);
void viro_pop_fd(struct ofpbuf *);
void packet_set_viro(struct ofpbuf *, ovs_be32 dst_sw, ovs_be16 dst_host, ovs_be32 src_sw, ovs_be16 src_host, ovs_be32 fd_sw, ovs_be16 fd_host);
