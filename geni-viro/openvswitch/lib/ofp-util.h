 ...
 * OFPUTIL_VIRO_AST_PUSH_FD
 * OFPUTIL_VIRO_AST_POP_FD
 *
...
#define VIRO_AST_ACTION(ENUM, STRUCT, EXTENSIBLE, NAME)   OFPUTIL_##ENUM,
...
#define VIRO_AST_ACTION(ENUM, STRUCT, EXTENSIBLE, NAME) + 1
    OFPUTIL_N_ACTIONS = 1
#include "ofp-util.def"
};
