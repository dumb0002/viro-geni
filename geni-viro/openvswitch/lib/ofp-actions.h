...
#define OFPACTS                                                     \
    ...
    DEFINE_OFPACT(GOTO_TABLE,      ofpact_goto_table,    ofpact)    \
                                                                    \
	DEFINE_OFPACT(VIRO_PUSH_FD,           ofpact_viro_push_fd,       ofpact) \
	DEFINE_OFPACT(VIRO_POP_FD,            ofpact_null,               ofpact) \
	DEFINE_OFPACT(VIRO_SET_VID_SW_FD,     ofpact_viro_set_vid_sw,    ofpact) \
	DEFINE_OFPACT(VIRO_SET_VID_SW_SRC,    ofpact_viro_set_vid_sw,    ofpact) \
	DEFINE_OFPACT(VIRO_SET_VID_SW_DST,    ofpact_viro_set_vid_sw,    ofpact) \
	DEFINE_OFPACT(VIRO_SET_VID_HOST_FD,   ofpact_viro_set_vid_host,  ofpact) \
	DEFINE_OFPACT(VIRO_SET_VID_HOST_SRC,  ofpact_viro_set_vid_host,  ofpact) \
	DEFINE_OFPACT(VIRO_SET_VID_HOST_DST,  ofpact_viro_set_vid_host,  ofpact)
