...
#error
    ...
    /* VIRO */
    {
    	MFF_VIRO_DST_SW, "viro_dst_sw", NULL,
    	MF_FIELD_SIZES(be32),
    	MFM_FULLY,
    	MFS_HEXADECIMAL,
    	MFP_NONE,
    	true,
    	NXM_VIRO_DST_SW, "NXM_VIRO_DST_SW",
    	NXM_VIRO_DST_SW, "NXM_VIRO_DST_SW",
    },
    {
    	MFF_VIRO_DST_HOST, "viro_dst_host", NULL,
    	MF_FIELD_SIZES(be16),
    	MFM_NONE,
    	MFS_HEXADECIMAL,
    	MFP_NONE,
    	true,
    	NXM_VIRO_DST_HOST, "NXM_VIRO_DST_HOST",
    	NXM_VIRO_DST_HOST, "NXM_VIRO_DST_HOST",
    },
    {
    	MFF_VIRO_SRC_SW, "viro_src_sw", NULL,
    	MF_FIELD_SIZES(be32),
    	MFM_FULLY,
    	MFS_HEXADECIMAL,
    	MFP_NONE,
    	true,
    	NXM_VIRO_SRC_SW, "NXM_VIRO_SRC_SW",
    	NXM_VIRO_SRC_SW, "NXM_VIRO_SRC_SW",
    },
    {
    	MFF_VIRO_SRC_HOST, "viro_src_host", NULL,
    	MF_FIELD_SIZES(be16),
    	MFM_NONE,
    	MFS_HEXADECIMAL,
    	MFP_NONE,
    	true,
    	NXM_VIRO_SRC_HOST, "NXM_VIRO_SRC_HOST",
    	NXM_VIRO_SRC_HOST, "NXM_VIRO_SRC_HOST",
    },
    {
    	MFF_VIRO_FD_SW, "viro_fd_sw", NULL,
    	MF_FIELD_SIZES(be32),
    	MFM_FULLY,
    	MFS_HEXADECIMAL,
    	MFP_NONE,
    	true,
    	NXM_VIRO_FD_SW, "NXM_VIRO_FD_SW",
    	NXM_VIRO_FD_SW, "NXM_VIRO_FD_SW",
    },
    {
    	MFF_VIRO_FD_HOST, "viro_fd_host", NULL,
    	MF_FIELD_SIZES(be16),
    	MFM_NONE,
    	MFS_HEXADECIMAL,
    	MFP_NONE,
    	true,
    	NXM_VIRO_FD_HOST, "NXM_VIRO_FD_HOST",
    	NXM_VIRO_FD_HOST, "NXM_VIRO_FD_HOST",
    },
};
